      ...
      <div id="nimble-top-section-save-ui" class="czr-preview-notification">
          ...
          <div class="sek-section-save">
              <button class="button sek-do-save-section far fa-save" type="button" title="<?php _e('Save', 'nimble-builder'); ?>">
                <?php _e('Save', 'nimble-builder'); ?>
              </button>
          </div>
          <button class="button sek-close-dialog far fa-times-circle" type="button" title="<?php _e('Close', 'nimble-builder'); ?>">
              <?php _e('Close', 'nimble-builder'); ?>
          </button>
      </div>
    </script>
